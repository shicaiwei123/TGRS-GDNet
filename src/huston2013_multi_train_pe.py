...
sys.path.append('..')
from models.resnet_ensemble import HSI_Lidar_CCR, HSI_Lidar_Couple_Late, HSI_Lidar_Couple_Cross_PE, HSI_Lidar_Couple_Share
...
from lib.model_develop import train_base_multi_PE
...
def deeppix_main(args):
    ...
    model = HSI_Lidar_Couple_Cross_PE(args, modality_1_channel, modality_2_channel)
    ...
    args.retrain = False
    train_base_multi_PE(model=model, cost=criterion, optimizer=optimizer, train_loader=train_loader,
